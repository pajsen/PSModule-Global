...
.NOTES
	Version:		1.0.0
	Author:			Admin-PJE
	Creation Date:	27/05/16
	Purpose/Change:	Initial script module development - Ecco.Global.psm1
#>

$ErrorActionPreference = "Continue"

Function Get-EcGlobalModuleDirectory {
	$Invocation = Get-Variable MyInvocation -Scope 1 -ValueOnly
	Split-Path -Parent $($Invocation.MyCommand.source)
}

Get-ChildItem (Get-EcGlobalModuleDirectory) -Recurse -Verbose:$false | Where-Object -Verbose:$false { $_.Name -like "func.global*" } | ForEach-Object {
    try{. $_.FullName}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUefBmThnhWA4Ya175ns790dyu
# fE6gggyvMIIGEDCCBPigAwIBAgITMAAAACpnbAZ3NwLCSQAAAAAAKjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUc68bTx/iiPt7j1vIWrpd9pE5qI8wDQYJKoZI
# hvcNAQEBBQAEggEAw22t0C9Xaea0MgkRHhvBElxYpOf0EVIo6nRZQSfv4SHJmhKv
# 8E9g+qv+eHRcRn5GWJU6V8Puje27S1uftyI5T37Pg2WFyuokhKiTvomUY/yQ6laP
# tj7U8fORRThwFQUsTI7pBnqmRsUUiJ+JcyGl0QVjp6sdFWKRqO91FoNlWbKcpzoj
# wBFkjowavoTFlZlFzWpYTtl3WdiSKGLOLN5c+ROSViQe0/xiH8g6rvTjQ71VkrJn
# bbqzY+htlKildr6p0ikjMgN6ATFJOz6UFa620KHxyENJaAC97DV961s2TeIWKUIk
# 71fsgC1PHkDOitxaQJahdZSLGhBEJohj6QTHUQ==
