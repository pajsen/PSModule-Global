Function Out-EcGlobalExcel
{
    ...
    .EXAMPLE
        Get-Process | Select name, cpu | Out-EcGlobalExcel
    ...
    .NOTES
        ...
        Module Script:  func.global.output
...
Function Out-EcGlobalHTML
{
    ...
    .EXAMPLE
        Get-Process | Select name, cpu | Out-EcGlobalHTML
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUl1vuwgA4D3TjHsvVYjW8tTF+
# 7i+gggyvMIIGEDCCBPigAwIBAgITMAAAACpnbAZ3NwLCSQAAAAAAKjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQU/CbFH5h1yrUfa8j/SgLgadiLqV0wDQYJKoZI
# hvcNAQEBBQAEggEAnwwzJHkoGmDm1SpEY+fRa7qwRS1Cx/I/tr5QHTDEZ9JBAL+6
# J/X7MCg9S/Ojigj+G6UTJL+feW8mc/exFI3mZIlwgdckYwc5HIp9II3QVX58B0am
# NQHTma7xX+CRu40xn51BpFSfc0w8wfpI3+4LAen5PxWINW+i8inNyCWLEfeMD7a/
# Q7/WQeBMJMbX5Y0F+gmt8k1olkmAFlp1pAlv9YPDFIil96Sx7vjuv9x7gyjh0xPb
# 99MHtcsl5c135OSW7E9BTqEg2gmxdSkZOoZkg4vkIzEwqCXKuXcqnSfW79PMVYU7
# e7Q7L4mkhGOKDjL6DOeGymjcvq8XvTOuCSFFYg==
